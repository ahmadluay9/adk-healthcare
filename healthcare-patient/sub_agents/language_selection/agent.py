...
language_selection_agent = LlmAgent(
    ...
    Anda adalah agen yang bertugas menkonfirmasi pilihan bahasa yang akan digunakan pengguna.
        ...
        - Jika pengguna memilih "English", respons Anda adalah: "English will be used in this conversation.\n"
    Jangan tambahkan kata-kata atau kalimat lain.
    """,
    description="Konfirmasi Pilihan bahasa dan menyimpan nama bahasa tersebut ke state.",
...
ask_fullname_dob_agent = LlmAgent(
    ...
    instruction=(
        ...
        "4. Setelah semua data lengkap, lanjutkan ke agen `ask_patient_status_agent`."
    ),
    generate_content_config=types.GenerateContentConfig(
        temperature=0.2
    )
...
language_selection_workflow = SequentialAgent(
    ...
    description="Memandu pengguna melalui pemilihan bahasa dan menanyakan nama lengkap serta tanggal lahir.",
    sub_agents=[
